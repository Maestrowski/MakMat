...
const AboutMeSection = () => {
  return (
    <section
      className="w-full min-h-screen bg-gradient-to-br from-white to-[#A8CDFF] dark:from-black dark:to-[#1A2035] text-black dark:text-white flex flex-col items-center py-20"
    >
      <h1 className="text-5xl font-bold mb-16 text-center text-[#0f52ba] dark:text-[#2563eb]">
        About Me
      </h1>
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-12">
        <div>
          <h2 className="text-4xl font-semibold mb-4 text-center text-[#0f52ba] dark:text-[#2563eb]">
            Past
          </h2>
